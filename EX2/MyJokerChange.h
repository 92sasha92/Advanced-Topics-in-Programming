...
public:
    ...
    bool getIsInitialized() const; // return true if the joker initialized
    void setInitializedTrue();
    void setInitialized(bool init);
    void setPosition(MyPoint &position_);
    void setNewJokerRep(Piece::RPSJokerTypes newRep);
    bool init(MyPoint &position, Piece::RPSJokerTypes newJokerRep); // initialize the joker position and representation
};
