...
class Parser {
  private:
	...
	static bool parseCommandLineHelper(string s1, string s2, int &numOfThreads, string &path);
  ...
  public:
	static void parseCommandLine(int argc, char* argv[], int &numOfThreads, string &path);
